<?php
/**
 * @author Walter Omedo - Frontier Optical Networks Limited -- Get Subscriber Details
 * 31st May 2017
 */
...
function call_soap_wsdl($method,$portaluser,$username,$password,$partner_code,$cur_time,$action,$version,$params,$subscriber_no,$query_type,$service) {
  ...
  $ns = 'http://safaricom.co.ke/schemas/partners/LTE_sharing/GetSubscriberDetails'; //Namespace of the web service.
